      ...
      <div className="content u-text-center text-gray-200 p-2">
        ...
        <Fade bottom delay={900}>
          <p className="mb-3">
            ...
            user-experience in mind. I also happen to have specialized
            experiences for creating internal applications for companies to
            provide better and efficient processes.
            <span className="mb-5" />
